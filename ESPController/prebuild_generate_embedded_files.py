...
def prepare_embedded_files(source, target, env):
    ...
    with open(os.path.join(include_dir,'EmbeddedFiles_AutoGenerated_Blobs.h'), 'w') as blobs,  open(os.path.join(include_dir,'EmbeddedFiles_AutoGenerated.h'), 'w') as f:
        f.write("// This is an automatically generated file, any changes will be overwritten on compiliation!\n")
        blobs.write("#pragma once\n")
