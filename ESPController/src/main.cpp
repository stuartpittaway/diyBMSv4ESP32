...
void CurrentMonitorSetAdvancedSettings(currentmonitoring_struct newvalues)
{
  ...
  mysettings.currentMonitoring_overvoltagelimit = (int16_t)(100.0F * newvalues.modbus.overvoltagelimit);
  mysettings.currentMonitoring_undervoltagelimit = (int16_t)(100.0F * newvalues.modbus.undervoltagelimit);
  mysettings.currentMonitoring_overcurrentlimit = (int32_t)(100.0F * newvalues.modbus.overcurrentlimit);
  mysettings.currentMonitoring_undercurrentlimit = (int32_t)(100.0F * newvalues.modbus.undercurrentlimit);
  mysettings.currentMonitoring_overpowerlimit = (int32_t)(newvalues.modbus.overpowerlimit);
