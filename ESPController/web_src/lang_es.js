...
$("#storage").text("almacenamiento de archivos");
$("#avrprogrammer").text("AVR programador");
$("#about").text("Información");

$("#modulesPage > h1").text("Módulos");

$("#globalConfig > h2").text("Configuración global");
$("#globalConfig > p").text("Configure todos los módulos para utilizar los siguientes parámetros:");

$("#mpBank").text("Grupo");
$("#mpModule").text("Módulo");
$("#mpVoltage").text("Voltaje");
$("#mpvmin").text("V. Mínimo");
$("#mptint").text("Temp interna &deg;C");
$("#mptext").text("Temp externa &deg;C");
$("#mpbypass").text("Derivación %");
$("#mpbpc").text("Recuento de paquetes incorrecto");
$("#mppktr").text("Paquetes recibidos");
$("#mpbal").text("Equilibrar la energía utilizada (mAh)");
...
$("#jslibrary").text("La biblioteca de JavaScript no se ha cargado correctamente, actualice la página.");
$("#saveerror").text("No se pudo guardar la configuración.");
$("#savesuccess").text("Ajustes guardados");

$("#warning1").text("Advertencia: la tensión de derivación del módulo es diferente a la configuración global");
$("#warning2").text("Advertencia: la temperatura de derivación del módulo es diferente a la configuración global");
