...
extern void CurrentMonitorSetRelaySettingsInternal(const currentmonitoring_struct &newvalues);
extern void CurrentMonitorSetRelaySettingsExternal(const currentmonitoring_struct &newvalues);
